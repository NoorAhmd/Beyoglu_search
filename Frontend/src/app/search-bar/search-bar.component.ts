...
export class SearchBarComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.httpClient.get('https://egitim.ankageo.com/api/records?q=' + ' ').subscribe((response: any) => {
    ...
    resetMe() {
        let extent = fromLonLat([31.6314, 41.0128])
        this.view = new View({
            center: extent,
            zoom: 6,
            minZoom: 2,
    ...
    onSearch(params: any) {
        ...
        this.searchResults = []
        this.resetMe()
        this.httpClient.get('https://egitim.ankageo.com/api/records?q=' + params.target.value).subscribe((response: any) => {
            this.searchResults = response.hits.hits
            this.removeLayer()
            this.resetMe()
            this.extent(response)
